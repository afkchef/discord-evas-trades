...
evas_positions = msg.retrieve_option_messages('1022585814183575603', discord_token)
print(evas_positions)

#Gets my open positions from rh account
...
#Open position if not in options profile
for pos in evas_positions:
    pos_split = pos.split(" ")
